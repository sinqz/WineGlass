...
public class ActorPathAction : MonoSingletonTemplateScript<ActorPathAction>
{
    ...
    private void Init()
    {
        ...
        for (int k = 0; k < 52; k++)
        {
            ...
            if (k % 13 == 0 || k == 4 || k == 17 || k == 30 || k == 43)
                ActorDic[k].MagicCell = MagicCell.Airport;
            ActorDic[k].CellType = (colorCell)(k % 4);
        }
        ...
        ActorDic[67].LastCell = ActorDic[49];
        ActorDic[10].ColorCell = ActorDic[52];
        ActorDic[23].ColorCell = ActorDic[57];
        ActorDic[36].ColorCell = ActorDic[62];
        ActorDic[49].ColorCell = ActorDic[67];
        ActorDic[10].JumpCell = null;
        ActorDic[23].JumpCell = null;
        ActorDic[36].JumpCell = null;
        ActorDic[49].JumpCell = null;
        ActorDic[10].MagicCell = MagicCell.Null;
        ActorDic[23].MagicCell = MagicCell.Null;
        ActorDic[36].MagicCell = MagicCell.Null;
        ActorDic[49].MagicCell = MagicCell.Null;
    }
}
